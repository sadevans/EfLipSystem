...
from research.espnet.asr.asr_utils import torch_load
from research.espnet.asr.asr_utils import get_model_conf
from research.espnet.asr.asr_utils import add_results_to_json
from research.espnet.nets.batch_beam_search import BatchBeamSearch
from research.espnet.nets.lm_interface import dynamic_import_lm
from research.espnet.nets.scorers.length_bonus import LengthBonus
# from research.espnet.nets.pytorch_backend.e2e_asr_transformer import E2E
...
class Model(torch.nn.Module):
    def __init__(self, modality, model_path, model_conf, rnnlm=None, rnnlm_conf=None,
        ...
        if modality == "audiovisual":
            from research.espnet.nets.pytorch_backend.e2e_asr_transformer_av import E2E
        else:
            from research.espnet.nets.pytorch_backend.e2e_asr_transformer import E2E
